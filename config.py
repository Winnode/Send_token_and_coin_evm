import json
erc20_file_path = 'erc20.json'
with open(erc20_file_path, 'r') as f:
    abi = json.load(f)

DATA= {
    'ethereum'      : {'rpc': 'wss://ethereum-sepolia.publicnode.com', 'scan': 'https://sepolia.etherscan.io', 'token': 'ETH', 'chain_id': 11155111},

    'optimism'      : {'rpc': 'https://rpc.ankr.com/optimism', 'scan': 'https://optimistic.etherscan.io/tx', 'token': 'ETH', 'chain_id': 10},

    'bsc'           : {'rpc': 'https://bsc-testnet.publicnode.com', 'scan': 'https://testnet.bscscan.com/', 'token': 'BNB', 'chain_id': 97},
    ...
    'linea'         : {'rpc': 'https://rpc.goerli.linea.build', 'scan': 'https://lineascan.build/tx', 'token': 'ETH', 'chain_id': 59140},
